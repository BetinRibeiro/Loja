package Controller.Model.Tabela.ItensCompostos;
...
public class ModelTabelaItemCompra extends AbstractTableModel {
	...
	public ItemCompra retornaItemCompra(int linha) {
