...
import Bin.Produto;
import Controller.ModelTabelaPesquisaProdutoVender;
	...
	void buscar() {
		try {
			...
			for (int i = 0; i < tamanho; i++) {
				...
				System.out.println(classif.getPreco()+" "+classif.getCusto()+" "+classif.getDescricao());
...
//					setVisible(true);
	...
	private void alterar() {
		...
		buscar();
			...
			JOptionPane.showMessageDialog(contentPanel, "Erro ao alterar produto");
		}
		}
